...
export const NewSourceConfiguration: React.FC<SetupSyncProps> = (props) => {
	...
	const setState = (newSourceState: NewSourceState) =>
		props.setState({ ...props.state, newSourceState: newSourceState });
	...
	if (props.state.newSourceState.sourceCreated) {
		return (
			<div className="tw-flex tw-flex-col tw-justify-top">
				<span className="tw-text-center tw-text-2xl tw-font-bold tw-mb-10">
					Source all setup!
				</span>
				<img
					src={sync}
					alt="sync success illustration"
					className="tw-h-[300px]"
				/>
			</div>
		);
	}
	...
	switch (props.state.connectionType!) {
		case ConnectionType.Snowflake:
			inputs = (
				<SnowflakeInputs
					state={props.state.newSourceState}
					setState={setState}
				/>
			);
			break;
	...
	return (
		<div className="tw-px-28 tw-flex tw-flex-col tw-w-full">
			<div className="tw-flex tw-mb-2 tw-text-2xl tw-font-semibold tw-text-slate-900">
				<img
					src={getConnectionTypeImg(connectionType)}
					alt="icon"
					className="tw-h-8 tw-mr-1.5"
				/>
				Connect to {getConnectionType(connectionType)}
			</div>
			<div className="tw-flex tw-flex-row">
				<form className="tw-pb-16 tw-w-[500px] tw-mr-10" onSubmit={submit}>
					<div className="tw-mb-4 tw-text-slate-600">
						Provide the settings and credentials for your data source.
					</div>
					{inputs}
				...
				<div className="tw-w-72 tw-ml-auto tw-text-xs tw-leading-5 tw-border-l tw-border-slate-200 tw-h-fit tw-py-2 tw-pl-8">
					<div className="">
						<div className="tw-text-[13px] tw-mb-1 tw-font-medium">
							Read our docs
						</div>
						Not sure where to start? Check out{" "}
						<a href="docs.fabra.io" className="tw-text-blue-500">
							the docs
						</a>{" "}
					...
					<div className="tw-my-5 tw-py-5 tw-border-y tw-border-slate-200">
						...
						If your warehouse is behind a firewall/private network, please add
						the following static IP addresses:
					...
					<div>
						...
						We're here to help!{" "}
						<a href="mailto:help@fabra.io" className="tw-text-blue-500">
							Reach out
						</a>{" "}
	...
	return (
		<Button
			className={mergeClasses(
				"tw-mt-8 tw-bg-slate-200 hover:tw-bg-slate-300 tw-border-slate-200 tw-w-48 tw-h-10",
				testColor
			)}
	...
	return (
		<>
			<div className="tw-flex tw-flex-row tw-items-center tw-mt-2 tw-mb-1">
				...
				<Tooltip
					placement="right"
					label="Pick a name to help you identify this source in the future."
				>
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						snowflakeConfig: { ...state.snowflakeConfig, username: value },
					});
				}}
			...
			<div className="tw-flex tw-flex-row tw-items-center tw-mt-4 tw-mb-1">
				...
				<Tooltip
					placement="right"
					label="Password for the user specified above."
				>
					<InfoIcon className="tw-ml-1 tw-h-3 tw-fill-slate-400" />
				</Tooltip>
			</div>
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						snowflakeConfig: { ...state.snowflakeConfig, password: value },
					});
				}}
			...
			<div className="tw-flex tw-flex-row tw-items-center tw-mt-4 tw-mb-1">
				...
				<Tooltip
					placement="right"
					label="The warehouse that will be used to run syncs in Snowflake."
				>
					<InfoIcon className="tw-ml-1 tw-h-3 tw-fill-slate-400" />
				</Tooltip>
			</div>
			...
			<div className="tw-flex tw-flex-row tw-items-center tw-mt-4 tw-mb-1">
				...
				<Tooltip
					placement="right"
					label="The role that will be used to run syncs."
				>
					<InfoIcon className="tw-ml-1 tw-h-3 tw-fill-slate-400" />
				</Tooltip>
			</div>
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						snowflakeConfig: { ...state.snowflakeConfig, role: value },
					});
				}}
				placeholder="Role"
			/>
				...
				<Tooltip
					...
					label={
						<div className="tw-m-2">
							<span>
								This is your Snowflake URL. Format may differ based on Snowflake
								account age. For details,{" "}
							</span>
							<a
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						snowflakeConfig: { ...state.snowflakeConfig, host: value },
					});
				}}
				placeholder="Host"
			/>
		...
		<>
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						redshiftConfig: { ...state.redshiftConfig, username: value },
					});
				}}
				placeholder="Username"
				label="Username"
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						redshiftConfig: { ...state.redshiftConfig, password: value },
					});
				}}
				placeholder="Password"
				label="Password"
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						redshiftConfig: { ...state.redshiftConfig, database_name: value },
					});
				}}
				placeholder="Database Name"
				label="Database Name"
			...
			<ValidatedInput
				id="host"
				value={state.redshiftConfig.host}
				setValue={(value) => {
					props.setState({
						...state,
						redshiftConfig: { ...state.redshiftConfig, host: value },
					});
				}}
				placeholder="Host"
				label="Host"
			...
			<ValidatedInput
				id="port"
				value={state.redshiftConfig.port}
				setValue={(value) => {
					props.setState({
						...state,
						redshiftConfig: { ...state.redshiftConfig, port: value },
					});
				}}
				placeholder="Port"
				label="Port"
		...
		<>
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						mongodbConfig: { ...state.mongodbConfig, username: value },
					});
				}}
				placeholder="Username"
				label="Username"
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						mongodbConfig: { ...state.mongodbConfig, password: value },
					});
				}}
				placeholder="Password"
				label="Password"
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						mongodbConfig: { ...state.mongodbConfig, host: value },
					});
				}}
				placeholder="Host"
				label="Host"
	...
	return (
		<>
			...
			<div className="tw-flex tw-flex-row tw-items-center tw-mt-4 tw-mb-1">
				...
				<Tooltip
					placement="right"
					label="The geographic location of your BigQuery dataset(s)."
				>
					<InfoIcon className="tw-ml-1 tw-h-3 tw-fill-slate-400" />
				</Tooltip>
			</div>
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						bigqueryConfig: { ...state.bigqueryConfig, location: value },
					});
				}}
			...
			<ValidatedInput
				...
				setValue={(value) => {
					props.setState({
						...state,
						bigqueryConfig: { ...state.bigqueryConfig, credentials: value },
					});
				}}
