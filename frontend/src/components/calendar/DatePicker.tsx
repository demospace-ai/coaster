...
export const DatePicker: React.FC<DatePickerProps> = ({ className, classNames, showOutsideDays = true, ...props }) => {
  return (
    <DayPicker
      showOutsideDays={showOutsideDays}
      className={mergeClasses("tw-p-3", className)}
      classNames={{
        ...
        nav_button:
          "tw-border tw-border-input hover:tw-bg-slate-500 hover:tw-text-white tw-h-7 tw-w-7 tw-bg-transparent tw-p-0 tw-opacity-50 hover:tw-opacity-100",
        ...
        head_row: "tw-flex",
        head_cell: "tw-text-slate-200 tw-rounded-md tw-w-9 tw-font-normal tw-text-[0.8rem]",
        ...
        day_selected:
          "tw-bg-blue-600 tw-text-white hover:tw-bg-blue-500 hover:tw-text-white focus:tw-bg-blue-600 focus:tw-text-white",
