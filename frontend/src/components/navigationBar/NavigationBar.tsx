import { ChartBarSquareIcon, Cog6ToothIcon, HomeIcon } from '@heroicons/react/24/outline';
...
export const NavigationBar: React.FC = () => {
  ...
  const route = "tw-inline-block tw-pt-[1px] tw-ml-[8px]";
  ...
  return (
    <>
      <div className="tw-min-w-[240px] tw-w-60 tw-h-full tw-flex tw-flex-col tw-box-border tw-border-r tw-border-solid tw-border-gray-200 tw-bg-gray-100">
        <NavLink className="tw-py-4 tw-px-4 tw-flex tw-flex-row tw-h-16 tw-box-border tw-border-b tw-border-solid tw-border-gray-200 tw-cursor-pointer tw-w-full tw-mb-4" to="/">
        ...
        <div className={routeContainer}>
          <NavLink className={({ isActive }) => classNames(navLink, isActive && "tw-bg-gray-300")} to={'/insights'}>
            ...
            <div className={route}>Insights</div>
          </NavLink>
        </div>
        <div className={routeContainer}>
          <NavLink className={({ isActive }) => classNames(navLink, isActive && "tw-bg-gray-300")} to={'/help'}>
        ...
        <div id="bottomSection" className="tw-mt-auto tw-mb-5">
          <div className={routeContainer}>
            <NavLink className={navLink} to="/workspacesettings">
