...
interface ToolbarProps extends Except<ToolbarItem, 'type'> { showTooltip?: boolean; }
    ...
    case 'icon': {
      ...
      return (
        <BaseToolbarButton
          ...
          disabled={!enabled}
          focusable={enabled}
          tooltip={props.showTooltip ? `${label}${shortcutString}` : undefined}
          onClick={onClick}
          active={isActive}
        >
    ...
    case 'label': {
      ...
      return (
        <BaseToolbarButton
          ...
          disabled={!enabled}
          focusable={enabled}
          tooltip={props.showTooltip ? `${description}${shortcutString}` : undefined}
          onClick={onClick}
          active={isActive}
        >
          {label}
  ...
  return (item: ToolbarItemUnion, index: number, _: ToolbarItemUnion[]) => {
    ...
    switch (item.type) {
      ...
      case ComponentItem.ToolbarMenu:
        return <ToolbarMenu item={item} toolbarState={toolbarState} key={item.key ?? index} showTooltip={props.showTooltip} />;
    }
  };
}
