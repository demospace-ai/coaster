...
import { useCreatePayoutMethod, useGetStripeDashboardLink, usePayoutMethods } from "src/rpc/data";
import { PayoutMethod, PayoutMethodType } from "src/rpc/types";

export const Payouts: React.FC = () => {
  return (
    <div className="tw-flex tw-flex-col">
      <div className="tw-text-2xl tw-font-bold tw-mb-2">Your payouts</div>
      <div>Once you have a reservation, you'll be able to track your payouts here.</div>
    </div>
  );
};
