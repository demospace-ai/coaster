...
export const Home: React.FC = () => {
  ...
  const categoryIcon =
    "tw-flex tw-flex-col tw-items-center tw-p-2 tw-h-20 tw-w-20 tw-rounded-xl tw-cursor-pointer tw-select-none hover:tw-shadow-centered";
  ...
  return (
    <div className="tw-flex tw-flex-col tw-items-center tw-pt-1 sm:tw-pt-5 tw-pb-24 tw-px-5 sm:tw-px-20">
      <div className="tw-flex tw-w-full tw-overflow-scroll tw-py-3 sm:tw-py-5 tw-justify-center xl:tw-px-48">
        <div className="tw-flex tw-h-full tw-w-full tw-gap-6 tw-justify-between">
