  ...
  return (
    <main className="tw-flex tw-items-center tw-justify-center tw-w-full tw-px-5 sm:tw-px-20 tw-mt-6 sm:tw-mt-10 tw-pb-16 sm:tw-pb-32">
      <div className="tw-w-full tw-max-w-4xl tw-text-base">
        <h1 className="tw-font-bold tw-text-4xl sm:tw-text-5xl tw-font-heading tw-mb-4 sm:tw-mb-6">About Us</h1>
        <Image src={BigSur} alt="Big Sur" className="tw-rounded-xl tw-mb-5 sm:tw-mb-8" sizes="60vw" />
        <h2 className="tw-text-2xl tw-font-semibold tw-font-heading tw-mb-4">Find your next adventure</h2>
        <p className="tw-mb-5">
        ...
        <div className="tw-flex tw-gap-4">
          <div>
            <h2 className="tw-text-2xl tw-font-semibold tw-font-heading tw-mb-4">
              Unparalleled Convenience, Seamless Travel
            </h2>
            <p className="tw-mb-5">
        ...
        <h2 className="tw-text-2xl tw-font-semibold tw-font-heading tw-mb-4">Discover Your Adventure</h2>
        <p className="tw-mb-5">
        ...
        <h2 className="tw-text-2xl tw-font-semibold tw-font-heading tw-mb-4">Your Travel, Your Way</h2>
        <p className="tw-mb-5">
        ...
        <h2 className="tw-text-2xl tw-font-semibold tw-font-heading tw-mb-4">Our Journey</h2>
        <p className="tw-mb-5">
