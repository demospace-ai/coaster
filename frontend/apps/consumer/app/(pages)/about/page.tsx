  ...
  return (
    <main className="tw-mt-6 tw-flex tw-w-full tw-items-center tw-justify-center tw-px-5 tw-pb-16 sm:tw-mt-10 sm:tw-px-20 sm:tw-pb-32">
      <div className="tw-w-full tw-max-w-4xl tw-text-base">
        <h1 className="tw-mb-4 tw-text-4xl tw-font-bold sm:tw-mb-6 sm:tw-text-5xl">About Us</h1>
        <Image src={BigSur} alt="Big Sur" className="tw-mb-5 tw-rounded-xl sm:tw-mb-8" sizes="60vw" />
        <h2 className="tw-mb-4 tw-text-2xl tw-font-semibold">Find your next adventure</h2>
        <p className="tw-mb-5">
        ...
        <div className="tw-flex tw-gap-4">
          <div>
            <h2 className="tw-mb-4 tw-text-2xl tw-font-semibold">Unparalleled Convenience, Seamless Travel</h2>
            <p className="tw-mb-5">
        ...
        <h2 className="tw-mb-4 tw-text-2xl tw-font-semibold">Discover Your Adventure</h2>
        <p className="tw-mb-5">
        ...
        <h2 className="tw-mb-4 tw-text-2xl tw-font-semibold">Your Travel, Your Way</h2>
        <p className="tw-mb-5">
        ...
        <h2 className="tw-mb-4 tw-text-2xl tw-font-semibold">Our Journey</h2>
        <p className="tw-mb-5">
