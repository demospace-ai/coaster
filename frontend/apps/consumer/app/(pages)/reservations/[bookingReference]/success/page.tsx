...
export default async function Reservation({ params }: { params: { bookingReference: string } }) {
  return (
    <main className="tw-flex tw-flex-col tw-items-center tw-pt-20 sm:tw-pt-32">
      <div className="tw-text-3xl tw-font-bold">Success!</div>
      ...
      <Link
        className="tw-mt-5 tw-rounded-lg tw-border tw-border-solid tw-border-black tw-px-5 tw-py-2 tw-font-medium"
