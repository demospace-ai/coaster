...
export default function FinanceLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="tw-flex tw-justify-center tw-overflow-auto tw-px-8 tw-pb-24 tw-pt-6 sm:tw-pt-12">
      <div className="tw-flex tw-w-full tw-flex-col sm:tw-max-w-3xl">
        <div className="tw-mb-8 tw-text-3xl tw-font-bold">Finance</div>
        <div className="tw-mb-6 tw-flex tw-border-b tw-border-solid tw-border-slate-200">
          <NavLink
            href="/finance"
