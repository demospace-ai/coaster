...
export const DateRangePicker: React.FC<DayPickerProps> = ({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "tw-flex tw-flex-col sm:tw-flex-row tw-w-full tw-space-y-4 sm:tw-space-x-4 sm:tw-space-y-0",
        month: mergeClasses(
          "tw-flex tw-flex-col tw-w-full tw-space-y-4 tw-border-0 sm:tw-border sm:tw-p-4 tw-rounded-lg",
          month
        ),
        caption: mergeClasses(
        ...
        head_row: "tw-flex",
        head_cell:
          "tw-text-slate-200 tw-rounded-md tw-w-full tw-font-normal tw-text-sm",
        ...
        day_range_middle:
          "aria-selected:!tw-bg-blue-500 aria-selected:tw-text-white",
          ...
          >
            ...
            >
              <DateRangePicker
                ...
                components={
                  loading
                    ? { Day: () => <Loading className="tw-opacity-30" /> }
                    : {}
                }
              />
            </div>
