...
export const ProfileDropdown: React.FC<{ onHostApp?: boolean }> = ({ onHostApp }) => {
                ...
                <div className="tw-flex tw-flex-col tw-m-2 tw-py-2">
                  <Menu.Item>
                    <div className={navItem} onClick={logout}>
                      <ArrowRightStartOnRectangleIcon className="tw-h-4 tw-inline tw-mr-2 tw-stroke-2" />
                      Logout
                    </div>
                  </Menu.Item>
                </div>
...
export const MobileMenu: React.FC<{ onHostApp?: boolean }> = ({ onHostApp }) => {
