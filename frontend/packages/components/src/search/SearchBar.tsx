...
export const SearchBar: React.FC = () => {
  ...
  const search = () => {
    if (query.length > 0) {
      trackEvent("Products Searched", { query });
  ...
  return (
    <form
      ...
      className="tw-flex tw-flex-row tw-items-center tw-w-full tw-max-w-[400px] tw-h-12 tw-bg-white tw-shadow-dark-sm tw-p-1.5 tw-rounded-[99px] tw-cursor-text sm:tw-mt-1 tw-px-5"
    >
      <input
        ref={inputRef}
        value={query}
