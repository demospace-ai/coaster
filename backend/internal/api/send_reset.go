...
func (s ApiService) SendReset(w http.ResponseWriter, r *http.Request) error {
	...
	if sendResetRequest.Destination != "" {
		destinationParam = "destination=" + sendResetRequest.Destination
	} else {
		destinationParam = ""
	}
	...
	err = emails.SendEmail("Coaster Support <support@trycoaster.com>", "support@trycoaster.com", []string{sendResetRequest.Email}, "Reset your password", html.String(), plain.String())
	if err != nil {
